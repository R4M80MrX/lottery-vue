<template>
  <div>
    ...
    <!--所有购物项-->
    <cart-item v-for="cartItem in getCarts" :key="cartItem.red +'-'+cartItem.blue"
               :item="cartItem"></cart-item>
    ...
    <!--5.底部菜单栏-->
    <div class="menu">
      <div class="col-xs-12 menu-item text-center" style="height: 50px;line-height: 50px;">
